/*
 * OperationalAnalyticsService.js
 * Domain Service for Milestone B-12: Operational Lifecycle, Shift Durations & Fleet Analytics
 * Consumes read-model data from analyticsRepository with semantic status preservation.
 */

import { analyticsRepository } from "../../repositories/analyticsRepository.js";
import { formatMetric, DATA_STATUS, POPULATION_SCOPES } from "./AnalyticsContract.js";
...
export class OperationalAnalyticsService {
  ...
  /**
   * Fetch operational lifecycle summary metrics
   */
  async getOperationalSummary({ startDate, endDate, date, zoneId = null } = {}) {
    ...
    // Rate calculations with explicit population denominators
  ...
  /**
   * Fetch fleet utilization breakdown
   */
