...
export function DomainMetricsBar({ selectedZoneId = null, className = "" }) {
  ...
  return (
    <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 select-none items-stretch ${className}`}>
      {/* ------------------------------------------------------------- */}
      {/* CARD 1: Kepadatan Titik Ramai (POI)                           */}
      {/* ------------------------------------------------------------- */}
