...
export function AuthLayout({ children }) {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-100 dark:bg-slate-950 flex items-center justify-center p-3 sm:p-6 lg:p-10 font-['Inter'] relative transition-colors duration-300">
      ...
      <div className="w-full max-w-6xl bg-white dark:bg-slate-900 rounded-[28px] sm:rounded-[36px] shadow-2xl border border-slate-200/80 dark:border-slate-800 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[660px]">
        ...
        <div className="lg:col-span-6 bg-white dark:bg-slate-900 p-6 sm:p-10 lg:p-12 flex flex-col justify-between transition-colors duration-300 relative">
          {/* Top-Right Theme Toggle inside the form panel */}
          <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-20">
            <ThemeToggle
              variant="button"
              size="sm"
              className="hover:scale-105 shadow-xs"
            />
          </div>
