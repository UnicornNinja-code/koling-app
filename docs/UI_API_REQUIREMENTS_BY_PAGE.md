...
Dengan pendekatan **UI First**, seluruh kebutuhan endpoint di atas telah dipetakan secara terstruktur sesuai dengan elemen antarmuka yang ada pada referensi desain `assets/img/`. Frontend services (`src/services/`) dapat langsung memanfaatkan endpoint-endpoint ini untuk merender halaman yang 100% presisi dengan desain mockups.
