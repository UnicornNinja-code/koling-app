 ...
 *   Copyright (c) 2026 
 *   All rights reserved.
 *   Auth Service implementing business logic without Prisma (using PostgreSQL pg pool models)
 */
 ...
 * Admin/Supervisor accounts must be created via internal admin dashboard only.
 */
...
export const sendPasswordResetInstructionService = async (email, token) => {
    ...
    try {
        ...
        // Fallback: log token ke console agar dev tetap bisa bekerja
