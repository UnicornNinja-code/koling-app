 ...
 *   Copyright (c) 2026 
 *   All rights reserved.
 *   overpassWorker.js (BullMQ Worker Consumer for Overpass POI & Road Sync Jobs)
 */
...
export const overpassWorker = new Worker(
  ...
  },
  {
    ...
    concurrency: 1, // Isolated concurrency to respect OSM rate limits
  }
);
...
overpassWorker.on("completed", async (job, result) => {
  ...
  // Log to cron_logs and audit_logs
